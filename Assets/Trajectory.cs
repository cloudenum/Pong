...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        RaycastHit2D[] circleCastHit2DArray = Physics2D.CircleCastAll(
            ballRigidbody.position, ballCollider.radius,
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
                ...
                circleCastHit2D.collider.GetComponent<BallControl>() == null)
            {
                ...
                // yaitu sebuah titik yang di-offset dari titik tumbukan 
                // berdasar vektor normal titik tersebut sebesar jari-jari bola.
    ...
    public void ToggleBallAtCollision()
    {
        Debug.Log("BallAtCollision: " + ballAtCollision.activeSelf);
        ballAtCollision.SetActive(this.enabled);
        Debug.Log("Toggled BallAtCollision: " + ballAtCollision.activeSelf);
    }
}
